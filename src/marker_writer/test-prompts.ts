...
function check(ok: boolean, msg: string) {
  return ok ? `  ${C.green}[+]${C.reset} ${msg}` : `  ${C.red}[-]${C.reset} ${msg}`;
}
...
export const ALL_TESTS: TestCase[] = [
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    validationChecks: [
      ...
      {
        description: "Does not begin by repeating 'Tesla' or 'Chinese competitors' as first clause",
        check: (r) => {
  ...
  },
  {
    ...
    userInstruction: "write a compelling opening paragraph that hooks the reader",
    ...
    validationChecks: [
      ...
      {
        description: "Generated text does not mention the 23% stat (that comes after)",
      ...
      },
      {
        ...
        check: (r) => {
          const generatedIdx = r.finalDocument.indexOf(r.generatedText.trim().slice(0, 30));
          const originalIdx = r.finalDocument.indexOf("23% higher productivity");
  ...
  },
  {
    ...
    category: "BASIC_POSITION",
    rawInput: `${M}`,
    userInstruction: "Write a blog post about why most productivity advice is wrong",
    ...
    validationChecks: [
      ...
      },
      {
        ...
        check: (r) =>
          /productiv|advice|work|habit|routine|focus|time|task/i.test(r.generatedText),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    validationChecks: [
      ...
      },
      {
        ...
        check: (r) =>
          r.finalDocument.includes("The most effective way to learn a new language is") &&
  ...
  },
  {
    ...
    validationChecks: [
      ...
      },
      {
        ...
        check: (r) => r.finalDocument.includes("While many companies have adopted AI tools"),
      },
      {
        description: "Generated text provides a contrasting or completing main clause",
  ...
  },
  {
    ...
    validationChecks: [
      ...
      {
        description: "Final document preserves both the em-dash aside and the 300% clause",
        check: (r) =>
  ...
  },
  {
    ...
    validationChecks: [
      ...
      {
        description: "Generated text names a concept or approach (substantive completion)",
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    userInstruction: "write a transition section that deepens the problem before the solution",
    ...
    validationChecks: [
      ...
      },
      {
        ...
        check: (r) => {
          ...
          const genIdx = r.finalDocument.indexOf(r.generatedText.trim().slice(0, 20));
  ...
  },
  {
    ...
    validationChecks: [
      ...
      {
        description: "Final document contains both the Italian and American paragraphs",
        check: (r) =>
      ...
      },
      {
        ...
        check: (r) => {
          ...
          const americaIdx = r.finalDocument.indexOf("In America, coffee is fuel");
  ...
  },
  {
    ...
    validationChecks: [
      ...
      {
        description: "Generated text is topically relevant to dreams or sleep science",
        check: (r) =>
  ...
  },
  {
    ...
    userInstruction: "wrap up the argument and transition to the practical section",
    ...
    validationChecks: [
      ...
      },
      {
        ...
        check: (r) => r.finalDocument.includes("## How to Audit Your Training Data"),
      },
      {
        description: "Generated text relates to data quality or the preceding argument",
        check: (r) =>
          /data|model|quality|train|audit|garbage|organiz/i.test(r.generatedText),
      },
    ],
  },
    ...
    validationChecks: [
      ...
      },
      {
        ...
        check: (r) =>
          ...
          r.finalDocument.includes("mentally exhausted after intensive cognitive work"),
      },
      {
        description: "Generated text mentions an organ or makes a comparison",
        check: (r) =>
          /organ|heart|liver|muscle|kidney|lung|body|compar/i.test(r.generatedText),
      },
    ],
  },
  {
    ...
    validationChecks: [
      ...
      },
      {
        ...
        check: (r) =>
          ...
          r.finalDocument.includes("Understanding these biases is the first step"),
      },
      {
        description: "Generated text names or describes a specific bias or scenario",
        check: (r) =>
  ...
  },
  {
    ...
    validationChecks: [
      ...
      {
        description: "Final document contains both the original French paragraphs",
        check: (r) =>
  ...
  },
  {
    ...
    validationChecks: [
      ...
      },
      {
        ...
        check: (r) =>
          r.finalDocument.includes("## Die Zukunft der deutschen Automobilindustrie"),
      },
    ],
  },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    validationChecks: [
      ...
      },
      {
        ...
        check: (r) =>
          r.generatedText.trim().split(/\s+/).length >= 10,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    validationChecks: [
      ...
      {
        description: "Generated text maintains narrative voice and references Eleanor or the lighthouse",
        check: (r) =>
          /Eleanor|lighthouse|Portmore|keeper|dusk|Tuesday|dark/i.test(r.generatedText),
      },
      {
        description: "Final document preserves the original story opening",
        check: (r) => r.finalDocument.includes("The lighthouse had been dark for eleven years"),
      },
    ],
  },
  {
    ...
    validationChecks: [
      ...
      {
        description: "Final document contains both Methodology and Results sections",
        check: (r) =>
  ...
  },
  {
    ...
    validationChecks: [
      ...
      },
      {
        ...
        check: (r) =>
          r.finalDocument.includes("The reason most diets fail isn't willpower"),
      },
      {
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    userInstruction: "rewrite the highlighted section to be more professional and specific",
    ...
    validationChecks: [
      ...
      {
        description: "Generated text does not contain the weak original phrases",
        check: (r) =>
  ...
  },
  {
    ...
    userInstruction: "enhance the highlighted section with more vivid language and specific data",
    expectedPosition: "REGION_SELECTED",
    ...
    validationChecks: [
      ...
      {
        description: "Generated text is longer or richer than a minimal placeholder",
        check: (r) => r.generatedText.trim().split(/\s+/).length >= 20,
      },
      {
        description: "Final document contains surrounding context",
        check: (r) =>
          r.finalDocument.includes("Climate change is one of the defining challenges") &&
  ...
  },
  {
    ...
    category: "EDGE_CASE",
    rawInput: "To authenticate with the API, include your key in the Authorization header:\n\n```http\nGET /api/v1/users HTTP/1.1\nHost: api.example.com\nAuthorization: Bearer YOUR_API_KEY\n```\n\n" + `${M}`,
    userInstruction: "",
    expectedPosition: "END_OF_TEXT",
    expectedOperation: "CONTINUE",
    validationChecks: [
  ...
  },
  {
    ...
    validationChecks: [
      ...
      },
      {
        ...
        check: (r) => r.finalDocument.includes("# The Hidden Cost of Remote Work"),
      },
      {
        description: "Generated text is topically relevant to remote work",
        check: (r) =>
          /remote|work|cost|home|office|distributed|team|productiv/i.test(r.generatedText),
      },
    ],
  },
  {
    ...
    validationChecks: [
      ...
      {
        description: "Generated text discusses protocols or cryptographic concepts",
        check: (r) =>
  ...
  },
  {
    ...
    userInstruction: "write about quantum computing and its applications in cryptography",
    expectedPosition: "END_OF_TEXT",
    expectedOperation: "CONTINUE",
    validationChecks: [
      {
  ...
  },
  {
    ...
    validationChecks: [
      ...
      },
      {
        ...
        check: (r) => r.finalDocument.includes("Today, cryptography is everywhere"),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    userInstruction: "add one sentence bridging ancient practice and modern science",
    expectedPosition: "MID_PARAGRAPH",
    expectedOperation: "BRIDGE",
    validationChecks: [
      {
      ...
      },
      {
        ...
        check: (r) =>
          r.finalDocument.includes("Meditation has been practiced for thousands of years") &&
          r.finalDocument.includes("Modern neuroscience has confirmed"),
      },
      {
        description: "Generated text is relatively brief (bridging sentence, not essay)",
  ...
  },
  {
    ...
    userInstruction: "",
    // The parser processes the first CONTINUE marker it finds
    expectedPosition: "MID_PARAGRAPH",
    expectedOperation: "BRIDGE",
    validationChecks: [
      {
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    validationChecks: [
      ...
      {
        description: "Generated sentences are relatively short (avg <= 15 words)",
        check: (r) => {
...
export async function runTest(test: TestCase): Promise<TestResult> {
  ...
  try {
    ...
    const checkResults = test.validationChecks.map((vc) => {
      let passed = false;
      try {
        passed = vc.check({ ...partialResult, passed: false, checkResults: [] });
      } catch {
        passed = false;
      }
...
function printResult(result: TestResult): void {
  ...
  console.log(
    check(result.positionMatch, `Position: expected ${C.cyan}${result.testCase.expectedPosition}${C.reset}, got ${C.cyan}${result.testCase.expectedPosition !== (result.testCase.expectedPosition) ? "???" : result.positionMatch ? result.testCase.expectedPosition : "MISMATCH"}${C.reset}`),
  );
  console.log(
    check(result.operationMatch, `Operation: expected ${C.cyan}${result.testCase.expectedOperation}${C.reset}`),
  );
  ...
  if (result.generatedText) {
    const preview = result.generatedText.trim().slice(0, 120).replace(/\n/g, " ");
...
export async function runCategory(category: string): Promise<void> {
  ...
  if (tests.length === 0) {
    console.log(`${C.yellow}No tests found for category: ${category}${C.reset}`);
    console.log(
...
export async function runSingle(name: string): Promise<void> {
  ...
  if (!test) {
    console.log(`${C.yellow}No test found with name or id: "${name}"${C.reset}`);
    console.log(`\nAvailable tests:`);
